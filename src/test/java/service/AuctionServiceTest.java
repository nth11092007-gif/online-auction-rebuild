...
class AuctionServiceTest {
    ...
    void setUp() throws Exception {
        ...
        auctionService.setEventPublisher(feedServer::notifyObservers);
    ...
    void placeBid_Successful() throws Exception {
        ...
        when(sessionDAO.getSessionForPlaceBid(connection, sessionId)).thenReturn(openSession);
    ...
    void placeBid_SellerCurrentlyAllowed() throws Exception {
        when(sessionDAO.getSessionForPlaceBid(connection, "SS001")).thenReturn(openSession);
    ...
    void placeBid_ClosedSessionRejected() throws Exception {
        when(sessionDAO.getSessionForPlaceBid(connection, "SS002")).thenReturn(closedSession);
    ...
    void placeBid_PendingSessionRejected() throws Exception {
        when(sessionDAO.getSessionForPlaceBid(connection, "SS003")).thenReturn(pendingSession);
        when(userDAO.freezeMoneyAtomic(connection, 2, 150.0)).thenReturn(true);
        when(userDAO.refundMoneyAtomic(connection, 2, 150.0)).thenReturn(true);
    ...
    void placeBid_AntiSniping_NotTriggered() throws Exception {
        ...
        when(sessionDAO.getSessionForPlaceBid(connection, "SS004")).thenReturn(openSession);
    ...
    void placeBid_AntiSniping_Extends() throws Exception {
        ...
        when(sessionDAO.getSessionForPlaceBid(connection, "SS005")).thenReturn(openSession);
