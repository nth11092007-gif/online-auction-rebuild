...
public class AuctionDetailController {
    ...
    void handleQuickBid(ActionEvent event) {
        ...
        int amountToAdd = 0;
        switch (btn.getText()) {
            case "+0.5M" -> amountToAdd = 500000;
            case "+1.0M" -> amountToAdd = 1000000;
            case "+2.5M" -> amountToAdd = 2500000;
        }
    ...
    void HandleBid(ActionEvent event) {
        ...
        int currentUserId = ProfileController.currentUser.getID();
        ...
        if (isSuccess) {
            ...
            double currentBalance = ProfileController.currentUser.getBalance();
            double currentFrozen = ProfileController.currentUser.getFrozenBalance();
            ProfileController.currentUser.withdraw(bidAmount);

            // Cập nhật người dẫn đầu ngay lập tức trên giao diện
            lblHighestBidder.setText("Người dẫn đầu: " + ProfileController.currentUser.getUsername());
