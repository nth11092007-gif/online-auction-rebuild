        ...
        try {
            ...
            switch (itemType) {
                case "Vehicles":
                    ...
                    initItem = new Vehicles(0, itemName, ownerName, startPrice, description, vBrand, vMileage, vIdStr);
                    break;
                ...
                case "Electronics":
                    ...
                    initItem = new Electronics(0,itemName, ownerName, startPrice, description, eWarranty, eBrand);
                    break;
            }
