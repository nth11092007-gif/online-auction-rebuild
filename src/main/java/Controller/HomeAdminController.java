...
public class HomeAdminController {
    ...
    private void setupColumns() {
        // Bind dữ liệu từ getter của User vào từng cột
        ...
        // Cột trạng thái: badge Hoat dong / Da ban
        ...
        colStatus.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(Boolean banned, boolean empty) {
                ...
                if (empty || banned == null) { setGraphic(null); return; }

                Label badge = new Label(banned ? "Đã ban" : "Hoạt động");
        ...
        // Cột hành động: nút Ban / Unban động theo trạng thái
    ...
    private void loadUsers() {
        ...
        lblTotalUsers.setText(allUsers.size() + " nguoi dung");
    }
    ...
    private void handleToggleBan(User user) {
        ...
        confirm.setTitle(willBan ? "Xac nhan ban" : "Xac nhan go ban");
        confirm.setHeaderText(null);
        confirm.setContentText(willBan
                ? "Ban co chac muon BAN nguoi dung: " + user.getUsername() + "?"
                : "Ban co chac muon GO BAN nguoi dung: " + user.getUsername() + "?");
        ...
        if (success) {
            ...
            showAlert("That bai! Vui long thu lai.", Alert.AlertType.ERROR);
        }
    }
    ...
    void handleLogout(ActionEvent event) {
        ...
        if (confirm.showAndWait().orElse(ButtonType.CANCEL) == ButtonType.OK) {
            try {
                ...
                showAlert("Loi chuyen man hinh!", Alert.AlertType.ERROR);
            }
        }
    }
