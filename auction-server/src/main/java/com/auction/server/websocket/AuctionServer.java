...
import com.auction.server.websocket.command.Command;
import com.auction.server.websocket.command.GetSessionsCommand;
import com.auction.server.websocket.command.GetUserCommand;
import com.auction.server.websocket.command.JoinSessionCommand;
import com.auction.server.websocket.command.LoginCommand;
import com.auction.server.websocket.command.PlaceBidCommand;
import com.auction.server.websocket.command.SettleSessionCommand;
import com.auction.server.service.AuctionService;
import com.auction.server.service.SettlementService;
import com.auction.server.service.UserService;
import com.auction.server.service.ServiceFactory;
...
public class AuctionServer extends WebSocketServer {
  ...
  public AuctionServer(int port) {
      this(port,
              ...
              ServiceFactory.getInstance().getSettlementService(),
  ...
  private void initCommands() {
    ...
    commandMap.put("REGISTER",
        new com.auction.server.websocket.command.RegisterCommand(userService.getUserDao()));
